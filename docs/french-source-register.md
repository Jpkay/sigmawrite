...
| `fr-depp-eval6e-2025` | DEPP, évaluations nationales de début de 6e (2025) | Domain codes for reporting alignment | **Codes only** | domain identifier and SigmaWrite-authored label only | Official publication; no item content stored |
| `fr-dnb-francais` | Ministère de l’Éducation nationale, épreuve de français du DNB | Skill codes for reporting alignment | **Codes only** | skill identifier and SigmaWrite-authored label only | Official exam structure; no past-paper content stored |
