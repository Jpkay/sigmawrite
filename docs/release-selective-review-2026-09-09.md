...
> Historical release evidence. Current policy and integration status are in [the 13 September review checkpoint](diagnostic/workstreams/review-cleanup.md); the disabled-policy statements below describe this earlier release.
