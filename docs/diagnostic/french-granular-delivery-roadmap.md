...
- Separate working draft: 276 prepared pathways. Six more exact imperative lessons cover prendre, venir, partir, sortir, dire and voir, adding 36 guided exercises and 72 fresh sentence checks. All 706 assessment/conjugation tests and TypeScript pass; all eight constructed-profile checks pass and service journeys are running. It is not published.
