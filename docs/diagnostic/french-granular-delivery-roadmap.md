...
- Working draft: bank revision 13, 223 supported targets and 4,417 scoped probes. It adds four passé composé and four futur simple family pathways to the frozen candidate. It is not imported, published or deployed.
...
| --- | ---: |
| Prepared assessment, teaching and fresh-check pathway | 223 |
| Question pools allocated; exact-target lesson still missing | 65 |
