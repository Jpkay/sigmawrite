...
Three exact-target interpretation lessons provide 18 guided exercises. Each lesson contrasts the central message with a true detail and explicitly rejects the shortcut of always choosing the shortest answer. Its boundary distinguishes one sentence from a paragraph summary and reading an assertion from proving it true.

The question generator retains distinct passage-content identities and explicit assessed-sentence annotations. There is no additional textual-evidence question: the approved contract does not require it, and adding a correlated second choice would not justify lowering the guessing floor. All 36 questions remain `needs_human_review`.
