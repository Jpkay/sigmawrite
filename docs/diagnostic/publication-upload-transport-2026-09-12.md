...
Migration `20260912190000_granular_publication_uploads.sql` was applied to the linked Plume database and recorded in migration history. This does not enable the separate full-material-history contract. The revision 38 live upload is pending verification; public activation is a separate step.
