...
**Automated validation:** pending execution in CI at authoring time  
...
The slice supplies 48 atomic nodes, explicit hard/soft prerequisite rationales, L1 and FSL mappings, evidence criteria, seven misconception families, and five assessment-template purposes. Tests reject structural graph failures and assert coverage of every required v1 tense family.
