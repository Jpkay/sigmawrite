...
- [x] **5.1** Genre-by-grade production tasks: narration (6e/5e), argumentation (4e/3e), lettre, résumé; length bands per grade replace the fixed 50–100 words in `loadIndependentProductionTask`. **M**.
