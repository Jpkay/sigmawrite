...
import {PRESENT_SUBJUNCTIVE_MEANING_DRAFTS} from "../src/lib/diagnostic/granular/present-subjunctive-meaning";
...
for(const draft of PRESENT_SUBJUNCTIVE_MEANING_DRAFTS){
 ...
 const key=`v3-present-subjunctive-meaning:${draft.key}`;
...
const content={version:"french-v3-present-subjunctive-meaning-expansion-v1",status:"draft_requires_review",parentTaxonomyChecksum:artifact.manifest.contentChecksum,sourceBankChecksum:validateCanonicalDiagnosticBank(base,artifact.taxonomy).manifest.checksum,items,annotations};
const outputPath="generated/french-v3-present-subjunctive-meaning-expansion.json";
