...
const mocks={
 ...
 '@/components/student-assignments':`export const StudentAssignments=()=>null;`,
...
try{
 ...
 const report={fixture:'local-real-home-component',hydratedInterestFallback:true,staleAsyncResultIgnored:true,accountRemountClearsRecommendation:true,pageErrors:errors,productionVerified:false};if(process.argv[2])writeFileSync(process.argv[2],JSON.stringify(report,null,2)+'\n');console.log(JSON.stringify(report));
