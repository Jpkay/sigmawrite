...
import { buildFrenchTaxonomyV2 } from "../src/lib/taxonomy/french-v2";
...
if (process.argv.includes("--check")) {
  ...
  if (current !== serialized) throw new Error("generated/french-taxonomy-v2.json is stale; run npm run taxonomy:build:v2");
} else {
