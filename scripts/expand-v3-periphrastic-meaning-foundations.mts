...
import {PERIPHRASTIC_MEANING_DRAFTS} from "../src/lib/diagnostic/granular/periphrastic-meaning-foundations";
...
for(const draft of PERIPHRASTIC_MEANING_DRAFTS){
 ...
 const key=`v3-periphrastic-meaning-foundations:${draft.key}`;
...
const content={version:"french-v3-periphrastic-meaning-foundations-expansion-v1",status:"draft_requires_review",parentTaxonomyChecksum:artifact.manifest.contentChecksum,sourceBankChecksum:validateCanonicalDiagnosticBank(base,artifact.taxonomy).manifest.checksum,items,annotations};
const outputPath="generated/french-v3-periphrastic-meaning-foundations-expansion.json";
