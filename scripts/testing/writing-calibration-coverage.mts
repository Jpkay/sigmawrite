...
const report={status:"synthetic_coverage_only_not_calibrated",scope:"Source-bound synthetic cases using the current evaluator, including targeted transport regressions; missing or stale cases do not count",targetCount:rows.length,
