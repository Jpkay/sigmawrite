...
export function selectedDraftExpansionSources(args:readonly string[]):readonly string[]{
 ...
 return [...FRENCH_DRAFT_EXPANSION_SOURCES,...(options.verbFamilyRecognition?['verb-family-recognition-faceted']:[]),...(options.etreParticipleAgreement?['etre-participle-agreement']:[])];
}
export function selectedTeachingDrafts(args:readonly string[]){
 ...
 return [...FRENCH_TEACHING_DRAFTS,...(options.verbFamilyRecognition?VERB_FAMILY_RECOGNITION_TEACHING:[]),...(options.etreParticipleAgreement?ETRE_PARTICIPLE_AGREEMENT_TEACHING:[])];
}
