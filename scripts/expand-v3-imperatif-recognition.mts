...
import {IMPERATIF_RECOGNITION_DRAFTS} from "../src/lib/diagnostic/granular/imperatif-recognition";
...
for(const draft of IMPERATIF_RECOGNITION_DRAFTS){
 ...
 const key=`v3-imperatif-recognition:${draft.key}`;
...
const content={version:"french-v3-imperatif-recognition-expansion-v1",status:"draft_requires_review",parentTaxonomyChecksum:artifact.manifest.contentChecksum,sourceBankChecksum:validateCanonicalDiagnosticBank(base,artifact.taxonomy).manifest.checksum,items,annotations};
const outputPath="generated/french-v3-imperatif-recognition-expansion.json";
