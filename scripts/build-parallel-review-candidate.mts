...
// New subjunctive and imperative family pathways assess sentences. Older isolated
// form drills remain in the canonical bank and in historical published releases.
const sentenceFamilyTargets=new Set(adapted.assessment.probes.filter(p=>(p.id.startsWith("v3-subjonctif-family-production:")||p.id.startsWith("v3-imperatif-family-production:")||p.id.startsWith("v3-imperatif-verb-production:")||p.id.startsWith("v3-imperatif-recognition:"))).map(p=>p.skillId));
