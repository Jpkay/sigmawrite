...
const sentenceFamilyTargets=new Set(adapted.assessment.probes.filter(p=>(p.id.startsWith("v3-past-tense-foundations:")||p.id.startsWith("v3-subjonctif-family-production:")||p.id.startsWith("v3-imperatif-family-production:")||p.id.startsWith("v3-passe-simple-family-production:")||p.id.startsWith("v3-passe-simple-verb-production:")||p.id.startsWith("v3-imperatif-verb-production:")||p.id.startsWith("v3-vouloir-imperative:")||p.id.startsWith("v3-imperatif-recognition:")||p.id.startsWith("v3-etre-participle-agreement:")||p.id.startsWith("v3-question-detail-reading:")||p.id.startsWith("v3-local-definition-reading:")||p.id.startsWith("v3-avoir-participle-agreement:")||p.id.startsWith("v3-causal-reading-genres:")||p.id.startsWith("coverage-cause-relation:"))).map(p=>p.skillId));
...
const refinementFlag=(selectedOptions.verbFamilyRecognition?" --verb-family-recognition":"")+(selectedOptions.etreParticipleAgreement?" --etre-participle-agreement":"")+(selectedOptions.questionDetailReading?" --question-detail-reading":"")+(selectedOptions.localDefinitionReading?" --local-definition-reading":"")+(selectedOptions.avoirParticipleAgreement?" --avoir-participle-agreement":"")+(selectedOptions.causalReadingGenres?" --causal-reading-genres":"")+(selectedOptions.causeRelationFamily?" --cause-relation-family":"");
