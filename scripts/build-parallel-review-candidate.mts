...
const sentenceFamilyTargets=new Set(adapted.assessment.probes.filter(p=>(p.id.startsWith("v3-subjonctif-family-production:")||p.id.startsWith("v3-imperatif-family-production:")||p.id.startsWith("v3-imperatif-recognition:"))).map(p=>p.skillId));
