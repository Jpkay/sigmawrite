...
const refinementFlag=(selectedOptions.verbFamilyRecognition?" --verb-family-recognition":"")+(selectedOptions.etreParticipleAgreement?" --etre-participle-agreement":"")+(selectedOptions.questionDetailReading?" --question-detail-reading":"")+(selectedOptions.localDefinitionReading?" --local-definition-reading":"");
