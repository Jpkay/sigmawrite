...
import {PAST_TENSE_FOUNDATION_DRAFTS} from "../src/lib/diagnostic/granular/past-tense-foundations";
...
for(const draft of PAST_TENSE_FOUNDATION_DRAFTS){
 ...
 const key=`v3-past-tense-foundations:${draft.key}`;
...
const content={version:"french-v3-past-tense-foundations-expansion-v1",status:"draft_requires_review",parentTaxonomyChecksum:artifact.manifest.contentChecksum,sourceBankChecksum:validateCanonicalDiagnosticBank(base,artifact.taxonomy).manifest.checksum,items,annotations};
const outputPath="generated/french-v3-past-tense-foundations-expansion.json";
