...
writeFileSync(recentOnly?'docs/diagnostic/passe-recent-learning-journeys-2026-09-12.json':futurOnly?'docs/diagnostic/futur-proche-learning-journeys-2026-09-11.json':spellingOnly?'docs/diagnostic/present-spelling-learning-journeys-2026-09-11.json':'docs/diagnostic/reference-learning-journeys-2026-09-11.json',JSON.stringify(output,null,2)+'\n');console.log(JSON.stringify(reports));
