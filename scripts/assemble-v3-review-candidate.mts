...
const annotations=[...(bankRevision!==undefined&&bankRevision>=45?resignRevision45BaseAnnotations(baseAnnotations,assembled.bank):baseAnnotations),...assembled.annotations];
const adapted=applyFacetTargets(adaptV3ForAssessment({artifact,bank:assembled.bank}),buildV3Facets(artifact.taxonomy,granularBankOptions(process.argv.slice(2))),assembled.bank,annotations).assessment;
