...
for(const lesson of lessons){
 ...
 if(targetRefinements.length!==required||targetRefinements.some(o=>!o.correct||!o.materialReceipt?.historyComplete||o.materialReceipt.previouslySeenKeys.length))throw Error('Independent checks lack fresh recorded material');
