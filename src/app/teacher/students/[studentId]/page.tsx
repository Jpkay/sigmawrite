  ...
  return (
    <>
      ...
      <section className="mt-9 border-t border-border pt-7">
        <h2 className="text-lg font-semibold">{language === "en" ? "Evidence by competency" : "Preuves par compétence"}</h2>
        <p className="mb-4 mt-1 text-sm text-muted-foreground">{language === "en" ? "Diagnostic evidence, prerequisite gaps, and expectations used to interpret the map." : "Preuves diagnostiques, écarts de prérequis et attentes utilisés pour interpréter la carte."}</p>
