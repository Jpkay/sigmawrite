...
export default async function ReviewerManagementPage() {
  ...
  return <><PageHeader title="Évaluateurs" description="Invitez un ou plusieurs éducateurs, activez leur accès et suivez leur première connexion."/><ReviewAdminNav/><ReviewerManager initialReviewers={(data??[]) as unknown as Parameters<typeof ReviewerManager>[0]["initialReviewers"]}/></>;
}
