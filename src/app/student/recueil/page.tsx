...
export default async function Page() {
  ...
  return (
    <>
      <PageHeader boundary="student:recueil-header" eyebrow="Mes écrits" title="Mon recueil" description={`Tes textes aboutis depuis le ${longDate(since)}. Imprime-le ou enregistre-le en PDF.`} actionText="Imprimer le recueil" action={<PrintButton label="Imprimer le recueil" />} />
