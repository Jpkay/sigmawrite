export type QueuedAnswer={sessionId:string;textKey:string;questionKey:string;choiceIndex:number;nextPhase?:"questions"|"summary"};const KEY="plume.offline.answers",LEGACY_KEY="sigmawrite.offline.answers";
