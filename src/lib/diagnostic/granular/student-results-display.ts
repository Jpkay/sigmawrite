...
export const STUDENT_RESULT_SUMMARY_COPY={
 ...
 emptyDescription:"Il faut encore quelques réponses pour voir ce que tu sais faire.",
 ...
 moreInDetails:"Tu trouveras d’autres points dans le bilan détaillé.",
 nextActivity:"Ce que tu peux faire ensuite",
