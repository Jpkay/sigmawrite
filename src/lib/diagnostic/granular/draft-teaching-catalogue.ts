...
export const FRENCH_TEACHING_DRAFTS:readonly TargetTeachingContent[]=[...INFORMATIONAL_SUBJECT_REFERENCE_TEACHING,...COUNTERARGUMENT_TEACHING,...ARGUMENT_REASON_TEACHING,...ARGUMENT_THESIS_TEACHING,...HOMOPHONE_TEACHING,...NEGATION_RECOGNITION_TEACHING,...SIMPLE_NEGATION_TEACHING,...PASSE_COMPOSE_TEACHING,
