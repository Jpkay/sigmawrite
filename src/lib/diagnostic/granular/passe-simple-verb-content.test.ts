...
it('provides separate verb targets with all persons and checks not used in teaching',async()=>{
 ...
 expect(lessons.map(l=>l.facetKey)).toEqual(['être','avoir','aller','faire','dire','prendre','voir','venir','partir','sortir','pouvoir','vouloir','savoir','devoir'].map(v=>'produire_passe_simple::verb:'+v));
 expect(artifact.items).toHaveLength(168);
...
it('rejects the corresponding present/imperfect forms and meaningful accent errors',async()=>{
 for(const [verb,person,correct,wrong] of [['être','3s','fut','fût'],['avoir','3s','eut','eût'],['faire','3s','fit','fît'],['aller','1s','allai','allais'],['avoir','1p','eûmes','eumes'],['être','2p','fûtes','futes'],['faire','1p','fîmes','fimes'],['dire','2p','dîtes','dites'],['prendre','3s','prit','pris'],['prendre','1p','prîmes','primes'],['voir','3s','vit','voit'],['voir','1p','vîmes','vimes'],['venir','3s','vint','vînt'],['venir','1p','vînmes','vînnmes'],['venir','2p','vîntes','vintes'],['partir','3s','partit','part'],['sortir','1p','sortîmes','sortimes'],['pouvoir','3s','put','pût'],['vouloir','2p','voulûtes','voulutes'],['savoir','3s','sut','sût'],['devoir','3s','dut','dû'],['devoir','1p','dûmes','dumes']] as const){
