...
const DIRECT_OBJECT_CHOICES:Readonly<Record<string,{sourceChecksum:string;question:string;choices:readonly [string,string,string,string]}>>={
 ...
 "v3-direct-object:indirect-only":{sourceChecksum:"sha256:0fc27df6793471589cd69d3ed1df9bbcea40ae68cf65fb794f70d07dd2822bc0",question:"Quel groupe répond à « Zoé téléphone qui ou quoi ? » sans ajouter « à » ? Choisis « Aucun » si rien ne convient.",choices:["Aucun","son cousin","Zoé","à son cousin"]},
 "v3-direct-object:sleep":{sourceChecksum:"sha256:96284a5ff436ce4d7d426d7ed25e54ad3762b27a62735317e0014f8fa39746fd",question:"Quel groupe répond à « Le bébé dort qui ou quoi ? » sans ajouter « dans » ? Choisis « Aucun » si rien ne convient.",choices:["Aucun","sa chambre","Le bébé","dans sa chambre"]},
 "v3-direct-object:attribute":{sourceChecksum:"sha256:89c53761119a27ea11fe2f2464105473d0ffa8c75af131c2aa3813f746b735c5",question:"Ici, « célèbre » décrit la musicienne après « est ». Quel groupe répond directement à « est qui ? » ou « est quoi ? » en nommant une autre personne ou chose ? Choisis « Aucun » si rien ne convient.",choices:["Aucun","célèbre","Cette musicienne","est"]},
 "v3-direct-object:provenance":{sourceChecksum:"sha256:97a1d48da53e01e5e11566ba0b3602927615f05a8678a9e663576ab92022858d",question:"Quel groupe répond à « Le car arrive qui ou quoi ? » sans ajouter « de » ? Choisis « Aucun » si rien ne convient.",choices:["Aucun","Bruxelles","Le car","de Bruxelles"]},
};
