...
const DIRECT_OBJECT_CHOICES:Readonly<Record<string,{sourceChecksum:string;question:string;choices:readonly [string,string,string,string]}>>={
 ...
 "v3-direct-object:indirect-only":{sourceChecksum:"sha256:0fc27df6793471589cd69d3ed1df9bbcea40ae68cf65fb794f70d07dd2822bc0",question:"Quel groupe peut compléter « Zoé téléphone ___ » sans ajouter « à » ? Choisis « Aucun » si aucun groupe ne convient.",choices:["Aucun","son cousin","Zoé","téléphone"]},
 "v3-direct-object:sleep":{sourceChecksum:"sha256:96284a5ff436ce4d7d426d7ed25e54ad3762b27a62735317e0014f8fa39746fd",question:"Quel groupe peut compléter « Le bébé dort ___ » sans ajouter « dans » ? Choisis « Aucun » si aucun groupe ne convient.",choices:["Aucun","sa chambre","Le bébé","dort"]},
 ...
 "v3-direct-object:provenance":{sourceChecksum:"sha256:97a1d48da53e01e5e11566ba0b3602927615f05a8678a9e663576ab92022858d",question:"Quel groupe peut compléter « Le car arrive ___ » sans ajouter « de » ? Choisis « Aucun » si aucun groupe ne convient.",choices:["Aucun","Bruxelles","Le car","arrive"]},
};
