...
const cases:Array<[string,string,string,[string,string,string],boolean,string]>=[
 ...
 ["sans-nom","Elle sourit.\n\nDans quelle autre phrase le mot devant « élève » est-il bien choisi ?","Cette élève sourit.",["Elle sourit.","Ces élève sourit.","Cette élèves sourit."],true,"Cette est placé devant le nom élève; dans elle sourit, elle remplace la personne qui sourit."],
 ["la-pronom","Je la regarde.\n\nDans quelle phrase « la » est-il placé juste devant « vitrine » ?","Je regarde la vitrine.",["Je la regarde.","La regarde est ouverte.","Je regarde les vitrines."],true,"Dans la vitrine, la est placé devant le nom vitrine; dans je la regarde, la remplace ce qui est regardé."],
 ["les-pronom","Tu les invites.\n\nDans quelle phrase « les » est-il placé juste devant « voisins » ?","Tu invites les voisins.",["Tu les invites.","Les invites arrivent.","Tu invites le voisin."],true,"Dans les voisins, les est placé devant le nom voisins; dans tu les invites, les remplace les personnes invitées."],
 ["leur-pronom","Nous leur parlons.\n\nDans quelle phrase « leur » est-il placé juste devant « professeure » ?","Nous parlons à leur professeure.",["Nous leur parlons.","Nous parlons à leurs professeure.","Nous parlons à leur."],true,"Dans leur professeure, leur est placé devant le nom professeure; dans nous leur parlons, leur remplace les personnes à qui nous parlons."],
];
