...
select is((select required_reviewers::int from content_review_settings where id),1,'The later one-review policy is the current default');
-- Preserve the historical two-review mechanism as an explicit editorial escalation.
update content_review_versions set required_reviewers=2 where id='b3420000-0000-4000-8000-000000000001';
select is((select required_reviewers::int from content_review_versions where id='b3420000-0000-4000-8000-000000000001'),2,'A version can still explicitly require two reviews');
...
select is((select required_reviewers::int from content_review_versions where id='b3420000-0000-4000-8000-000000000001'),2,'Assignments do not raise an explicit two-review threshold');
