...
-- Re-stamp the valid run as protocol v3 with its shorter bounds (roadmap 8.1).
update public.diagnostic_runs set protocol_version='graph-sections-v3', probe_count=32, total_min_probes=24, total_max_probes=48
  where id='69000000-0000-0000-0000-000000000040';
update public.diagnostic_run_sections set min_probes=6, max_probes=12, min_distinct_nodes=5, probe_count=8, distinct_nodes_tested=6
  where run_id='69000000-0000-0000-0000-000000000040';

select set_config('request.jwt.claim.role','service_role',true);
select ok(public.student_learning_is_unlocked('69000000-0000-0000-0000-000000000001'),'A completed v3 run (24–48 probes) unlocks learning');

update public.diagnostic_runs set total_max_probes=80 where id='69000000-0000-0000-0000-000000000040';
select is(public.student_learning_is_unlocked('69000000-0000-0000-0000-000000000001'),false,'A v3 run must carry the v3 bounds');

update public.diagnostic_runs set total_max_probes=48, protocol_version='graph-sections-v2' where id='69000000-0000-0000-0000-000000000040';
select is(public.student_learning_is_unlocked('69000000-0000-0000-0000-000000000001'),false,'v2 bounds are not relaxed');
